...
HOME_ASSISTANT_URL                = 'https://yourhomeassistanturl.com'       # REPLACE WITH THE URL FOR YOUR HA FRONTEND
VERIFY_SSL                        = TrueorFalse                              # SET TO FALSE IF YOU DO NOT HAVE VALID CERTS
TOKEN                             = 'YourHALongToken'                        # ADD YOUR LONG LIVED TOKEN IF NEEDED OTHERWISE LEAVE BLANK
